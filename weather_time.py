...
def n_weather_time(location):
    ...
    n_url = 'https://search.naver.com/search.naver?sm=top_hty&fbm=1&ie=utf8&query={}'.format(
        location+' 날씨')
    ...
    for i in n_localt:
        hour = i.text.replace(" ","") #값 주변 공백 삭제.
        time.append(hour)
        j = j+1
